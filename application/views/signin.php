                ...
                <div class="col-md-6">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="tanggal_lahir" placeholder="Tanggal Lahir Anda" required>
                        </div>
                        <div class="form-group">
                            <label for="alamat">Alamat</label>
                            <textarea class="form-control" name="alamat" rows="10" placeholder="Masukkan Alamat Anda" required></textarea>
                        </div>
                        <div class="form-group">
                            <label for="telepon">Nomor HP</label>
                            <input type="number" class="form-control" name="telepon" placeholder="Nomor Telepon Anda" required>
                        </div>
