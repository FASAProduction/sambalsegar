							...
							<div class="col-lg-3 col-md-6 col-12">
								<div class="single-product">
									<div class="product-img">
										<a href="#">
											<img class="default-img" src="<?= base_url('upload/' . $row['gambar']); ?>" alt="#">
											<img class="hover-img" src="<?= base_url('upload/' . $row['gambar']); ?>" alt="#">
										</a>
										<div class="button-head">
											<div class="product-action-2">
												<a title="Masukkan keranjang" href="<?= base_url('cart/add/' . $row['id_produk']); ?>">Masukkan keranjang</a>
											</div>
										</div>
									</div>
