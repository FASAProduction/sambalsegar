...
<head>
    ...
    <title>Sambal Resep Njenot - <?= $title; ?></title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item <?= ($title == 'Dashboard') ? 'active' : ''; ?>">
                <a class="nav-link" href="<?= base_url('produsen/dashboard'); ?>">
            ...
            <!-- <li class="nav-item  <?= ($title == 'Data Admin') ? 'active' : ''; ?>">
                <a class="nav-link" href="<?= base_url('produsen/admin'); ?>">
                    <i class="fas fa-fw fa-user"></i>
                    <span>Data Admin</span></a>
            </li> -->

            <!-- <li class="nav-item  <?= ($title == 'Data Pelanggan') ? 'active' : ''; ?>">
                <a class="nav-link" href="<?= base_url('produsen/pelanggan'); ?>">
                    <i class="fas fa-fw fa-users"></i>
                    <span>Data Pelanggan</span></a>
            </li> -->

            <!-- <li class="nav-item  <?= ($title == 'Data Produsen') ? 'active' : ''; ?>">
                <a class="nav-link" href="<?= base_url('produsen/produsen'); ?>">
                    <i class="fas fa-fw fa-users"></i>
                    <span>Data Produsen</span></a>
            </li> -->

            <li class="nav-item  <?= ($title == 'Data Produk') ? 'active' : ''; ?>">
                <a class="nav-link" href="<?= base_url('produsen/produk'); ?>">
            ...
            <li class="nav-item  <?= ($title == 'Pemesanan') ? 'active' : ''; ?>">
                <a class="nav-link" href="<?= base_url('produsen/pemesanan'); ?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?= base_url('produsen/profil'); ?>">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Profil
                                </a>
                                <a class="dropdown-item" href="<?= base_url('produsen/ubah-password'); ?>">
