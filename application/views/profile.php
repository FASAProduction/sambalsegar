...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<!-- Title Tag  -->
  <title>Sambal Resep Njenot - Profil Saya</title>
	<!-- Favicon -->
											...
											<div class="nav-inner">	
												<ul class="nav main-menu menu navbar-nav">
													...
													<?php if($this->session->userdata('id_pelanggan')): ?>
														...
														<li class="active"><a href="<?= base_url('profile'); ?>">Profil Saya</a></li>
													<?php endif; ?>
					...
					<div class="col-md-6">
						<form method="post">
							...
							<div class="form-group">
								...
								<input type="text" name="nama_lengkap" class="form-control" placeholder="Nama Lengkap" value="<?= $row['nama_lengkap']; ?>">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" name="telepon" class="form-control" placeholder="Telepon" value="<?= $row['telepon']; ?>">
							</div>
