...
$ad = $this->db->query("SELECT * FROM admin JOIN transaksi ON transaksi.id_admin=admin.id_admin WHERE kode_transaksi='$kd'")->result();
...
<table cellspacing='0' style='width:100%; font-size:11pt; font-family:calibri;  border-collapse: collapse;' border='1'>
...
<td style='text-align:right'><?php echo rupiah($total); ?></td></tr>
 <?php endforeach; ?>
...
<tr>
<td colspan = '4'><div style='text-align:right'>Terbilang : <b><?php echo penyebut($tota->totally); ?> Rupiah</b></div></td>
</tr>
<tr>
