    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item  <?= ($title == 'Data Admin') ? 'active' : ''; ?>">
                <a class="nav-link" href="<?= base_url('panel/admin'); ?>">
            ...
            <li class="nav-item  <?= ($title == 'Data Produk') ? 'active' : ''; ?>">
                <a class="nav-link" href="<?= base_url('panel/produk'); ?>">
            ...
            <li class="nav-item  <?= ($title == 'Pemesanan') ? 'active' : ''; ?>">
                <a class="nav-link" href="<?= base_url('panel/pemesanan'); ?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?= base_url('panel/ubah-password'); ?>">
