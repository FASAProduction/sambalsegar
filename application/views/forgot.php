        ...
        <div class="container">
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    ...
                    ?>
                    <p class="mb-4">Masukkan email Anda untuk melanjutkan.</p>
                    <?php } ?>
                    <form method="post" action="<?php echo base_url('forgot/change'); ?>">
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="email" name="email" class="form-control" placeholder="Email">
                        </div>
                        <button type="submit" class="btn">Berikutnya</button>
